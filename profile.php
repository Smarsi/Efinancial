...
if (isset($_POST['but_upload'])) {
    ...
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        // Insert record
        $query = "UPDATE users SET user_profile_path = '$name' WHERE id_user='$userid'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                    <h3 class="mt-4 text-center">Atualizar Perfil</h3>
                    <hr>
                        <form class="form" method="post" action="" enctype='multipart/form-data'>
                            ...
                            <div class="input-group col-md mb-3 mt-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="profilepic">Alterar Foto de Perfil</label>
                                </div>
