...
$cat_options = [];
$optionsquery = "SELECT id_category, category_name FROM categories WHERE category_type = 'revenue' AND id_user = $userid";
...
if (isset($_POST['add'])) {
    ...
    header('location: add_revenue.php');
}
...
if (isset($_GET['edit'])) {
    ...
    if (mysqli_num_rows($record) == 1) {
        ...
        $expenseamount = $n['revenue_value'];
        $revenue_description = $n['revenue_description'];
        $expensedate = $n['made_in_dt'];
        $expensecategory = $n['revenue_category'];
    } else {
        echo ("EDIT WARNING: AUTHORIZATION ERROR: Trying to Access Unauthorized data");
    }
}
...
<head>
    ...
    <title>Efinancial - Adicionar Receita</title>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
        ...
        <a class="dropdown-item" href="logout.php">Sair</a>
            ...
            <div class="container">
                <h3 class="mt-4 text-center">Adicionar Receita</h3>
                <hr>
                <div class="row ">
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                <label for="revenue_description" class="col-sm-6 col-form-label"><b>Descrição</b></label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control col-sm-12" value="<?php echo $revenue_description; ?>" id="revenue_description" name="revenue_description" required>
                                </div>
                            </div>
                            <div class="form-group row">
